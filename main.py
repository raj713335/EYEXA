...
def mainc():
	...
	while True:
		...
		cv2.putText(frame, "EYEXA Social Distancing AND MASK Analyser for COVID-19", (140, 45),
					cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
		cv2.rectangle(frame, (20, 60), (1170, 100), (170, 170, 170), 2)
		cv2.putText(frame, "RISK ANALYSIS", (30, 85),
		...
		tot_str = "TOTAL COUNT: " + str(len(idxs))
		high_str = "HIGH RISK COUNT: " + str(len(nsd))
		low_str = "LOW RISK COUNT: " + str(0)
		safe_str = "SAFE COUNT: " + str(len(idxs)-len(nsd))
		...
		cv2.putText(frame, "MASK DETECTION ANALYSIS", (40, H-40),
